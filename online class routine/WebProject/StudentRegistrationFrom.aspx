<%@ Page Title="" Language="C#" MasterPageFile="~/NormalMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentRegistrationFrom.aspx.cs" Inherits="WebProject.StudentRegistrationFrom" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="email_text_box" ErrorMessage="Email is required." ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
        ...
        <tr>
            ...
            <td style="height: 57px; width: 323px;">
                ...
                <asp:TextBox ID="batch_text_box" runat="server" Width="309px" Height="31px"></asp:TextBox>

            </td>
                <td>

                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="batch_text_box" ErrorMessage="Batch is required." ForeColor="Red" Font-Size="17px"></asp:RequiredFieldValidator>
